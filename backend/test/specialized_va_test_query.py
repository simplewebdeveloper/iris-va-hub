...
from context.specialized_va.context import UpdateContext
from context.specialized_va.context import GetContext
from context.specialized_va.context import GetLastIntent
from context.specialized_va.salon_response_context import ConversationContext
from context.specialized_va.salon_response_context import UpdateResponseContext
from context.specialized_va.salon_response_context import GetResponse
from context.specialized_va.salon_response_context import ClearContext
...
class SpecializedVaTestQuery:
    ...
    def test_query(self):
        ...
        intent_response = SvmClassification(utterance, specialized_va_root_clf_model_vectorizer, specialized_va_root_clf_model).classify_intent()
        ...
        if is_it_update == "update":
            ...
            path_to_look_for = os.path.join(specialized_va_update_clf_model_dir, matching_update_path_to_last_intent)
        ...
        svp_path_to_look_for = os.path.join(specialized_va_svp_model_dir, intent_response['intent'])
