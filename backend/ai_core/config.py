...
# Handoff VA paths #
handoff_va_clf_model_dir = os.path.join(base_dir, 'ai_core/handoff_va/clf')
...
handoff_va_svp_model_dir = os.path.join(base_dir, 'ai_core/handoff_va/svp/svp_models')
handoff_va_svp_model_dir_core = os.path.join(base_dir, 'ai_core/handoff_va/svp')
...
specialized_va_clf_model_dir = os.path.join(base_dir, 'ai_core/specialized_va/clf')
...
specialized_va_svp_model_dir = os.path.join(base_dir, 'ai_core/specialized_va/svp/svp_models')
specialized_va_svp_model_dir_core = os.path.join(base_dir, 'ai_core/specialized_va/svp')
